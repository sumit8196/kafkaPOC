...
public class TwitterProducerHighThroughput {
    ...
    Logger logger= LoggerFactory.getLogger(TwitterProducerHighThroughput.class);
    List<String> terms = Lists.newArrayList("Kafka","corona","omnicrone","bjp","lockdown");
